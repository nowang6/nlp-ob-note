NLP：具备扎实的数学基础，包括微积分、线性代数、概率论、统计学和信息论；熟悉传统深度学习和深度学习技术，例如词嵌入、神经网络、循环神经网络（RNN）、长短期记忆网络（LSTM）、序列到序列模型（seq2seq）和注意力机制；能够熟练使用Hugging Face API 和 BERT系列预训练模型完成各种 NLP 任务，如语言理解、文本分类、序列标注和命名实体识别。
